...
surrogate="http://purl.org/twc/semmdd" # Came from $CSV2RDF4LOD_BASE_URI when cr-create-convert-sh.sh created this script.
...
#-----------------------------------
# manual/AEAP_NYSERDA_Chem_94-12_v9_web.csv
sourceDir="manual"
datafile="AEAP_NYSERDA_Chem_94-12_v9_web.csv"
...
subjectDiscriminator="aeap-nyserda-chem-94-12-v9-web"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
...
#-----------------------------------
# manual/AEAP_crust_web_v3.csv
sourceDir="manual"
datafile="AEAP_crust_web_v3.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="aeap-crust-web-v3"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
...
#-----------------------------------
# manual/AEAP_phyto_web.csv
sourceDir="manual"
datafile="AEAP_phyto_web.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="aeap-phyto-web"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
...
#-----------------------------------
# manual/AEAP_rotifers_web.csv
sourceDir="manual"
datafile="AEAP_rotifers_web.csv"
data="$sourceDir/$datafile"
# Bootstrap conversion parameters (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Conversion-trigger):
subjectDiscriminator="aeap-rotifers-web"             # Additional part of URI for subjects created; must be URI-ready (e.g., no spaces).
commentCharacter=""                 # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
cellDelimiter=","                   # ONLY one character; complain to http://sourceforge.net/projects/javacsv/ otherwise.
header=                             # Line that header is on; only needed if not '1'. '0' means no header.
dataStart=                          # Line that data starts; only needed if not immediately after header.
