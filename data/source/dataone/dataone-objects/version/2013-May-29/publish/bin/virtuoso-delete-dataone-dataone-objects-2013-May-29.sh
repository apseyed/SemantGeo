...
#
# graph was http://purl.org/twc/semantgeo/source/dataone/dataset/dataone-objects/version/2013-May-29 during conversion
...
url='http://purl.org/twc/semantgeo/source/dataone/file/dataone-objects/version/2013-May-29/conversion/dataone-dataone-objects-2013-May-29.nt'
if [ -e $dump ]; then
...
url='http://purl.org/twc/semantgeo/source/dataone/file/dataone-objects/version/2013-May-29/conversion/dataone-dataone-objects-2013-May-29.ttl'
if [ -e $dump ]; then
   echo pvdelete.sh $graph
   ${CSV2RDF4LOD_HOME}/bin/util/pvdelete.sh $graph
   exit 1
...
url='http://purl.org/twc/semantgeo/source/dataone/file/dataone-objects/version/2013-May-29/conversion/dataone-dataone-objects-2013-May-29.rdf'
if [ -e $dump ]; then
   ${CSV2RDF4LOD_HOME}/bin/util/pvdelete.sh $graph
   exit 1
elif [ -e $dump.gz ]; then
...
#3> <> prov:wasAttributedTo <http://purl.org/twc/semantgeo/id/csv2rdf4lod/1dba50a6a6a21cec27278862992083bb> .
#3> <> prov:generatedAtTime "2013-06-15T15:51:51-04:00"^^xsd:dateTime .
#3> <http://purl.org/twc/semantgeo/id/csv2rdf4lod/1dba50a6a6a21cec27278862992083bb> foaf:name "convert-dataone-objects.sh" .
